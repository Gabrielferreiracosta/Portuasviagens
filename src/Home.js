...
import viagensHome from '../src/img/Sem Título-2.png';
                ...
                <div className="flex justify-center items-center flex-grow-0 flex-shrink-0 relative overflow-hidden gap-5">
                  ...
                  <div className="flex-grow-0 flex-shrink-0 w-[136px] h-[147px]">
                    <img alt="Mascote-Portuasviagens" src={mascoteCapa} className="w-[136px] h-[147px] absolute left-[519.5px] top-[-0.5px] object-cover" />
                      ...
                      {/* MENU */}
                <nav id="menu" className='flex justify-center font-Anton items-center flex-grow-0 flex-shrink-0 gap-2.5' >
                  <ul>
                    <li>
                    ...
                    <li>
                      ...
                      <button id="Dicas-btn" aria-label="dicas-btn"  className='flex justify-center items-center flex-grow-0 flex-shrink-0 w-[100px] h-[35px] relative overflow-hidden    hover:bg-cyan-200/50'>
                    ...
                    <li>
                      ...
                      <button id="Viagens-btn" aria-label="viagens-btn" className='flex justify-center items-center flex-grow-0 flex-shrink-0 w-[100px] h-[35px] relative    hover:bg-cyan-200/50'>
                      ...
                      <ul>
                        <li>
                            <Link to="/marrocos" path="./Marrocos">
                            <button id="Dicas-btn" aria-label="dicas-btn"  className='flex justify-center items-center flex-grow-0 flex-shrink-0 w-[100px] h-[35px] relative overflow-hidden    hover:bg-cyan-200/50'>
                              <p className='flex-grow-0 flex-shrink-0 text-base font-regular text-center text-white'>
                              Marrocos
                              </p>
                        ...
                        <li>
                            <Link to="/portugal" path="./Portugal">
                            <button id="Dicas-btn" aria-label="dicas-btn"  className='flex justify-center items-center flex-grow-0 flex-shrink-0 w-[100px] h-[35px] relative overflow-hidden   hover:bg-cyan-200/50'>
                              <p className='flex-grow-0 flex-shrink-0 text-base font-regular text-center text-white'>
                              Portugal
                              </p>
                        ...
                        <li>
                            <Link to="/argentina" path="./Argentina">
                            <button id="Dicas-btn" aria-label="dicas-btn"  className='flex justify-center items-center flex-grow-0 flex-shrink-0 w-[100px] h-[35px] relative overflow-hidden   hover:bg-cyan-200/50'>
                              <p className='flex-grow-0 flex-shrink-0 text-base font-regular text-center text-white'>
                              Argentina
                              </p>
                    ...
                    <button id="Conteudos-btn" aria-label="conteudos-btn"  className='flex justify-center items-center flex-grow-0 flex-shrink-0 w-[100px] h-[35px] relative    hover:bg-cyan-200/50'>
                      <p className='flex-grow-0 flex-shrink-0 text-base font-regular text-left text-white'>
                        Conteúdos
                      </p>
                    </button>
                    ...
                    <button id="Projetos-btn" aria-label="projetos-btn"  className='flex justify-center items-center flex-grow-0 flex-shrink-0 w-[100px] h-[35px] relative    hover:bg-cyan-200/50'>
                      <p className='flex-grow-0 flex-shrink-0 text-base font-regular text-left text-white'>
                        Projetos
                      </p>
                    </button>
                    ...
                    <Link to="/about" path="./About">
                      <button id="Sobre-btn" aria-label="sobre-btn" className='flex justify-center items-center flex-grow-0 flex-shrink-0 w-[100px] h-[35px] relative  hover:bg-cyan-200/50'>
                        <p className="flex-grow-0 flex-shrink-0 text-base font-regular text-left text-white">
                          Sobre nós
                        </p>
                      </button>
                  ...
                  <input className='flex justify-start items-center w-[235px] h-[35px] absolute left-[1100px] top-[180px] gap-5 px-5 py-2 bg-[#202580]/80 border  flex-grow-0 flex-shrink-0 text-sm font-light text-center text-[#99b4fa]' type="search" placeholder="Pesquise aqui" />
                
                </nav>
              </div>
            </div>
          </header>          
     <div className="inline-flex absolute top-[400px] gap-[100px]">
          ...
          <br></br>
        <img className='w-[350px] h-[435px]' src={caboDaRoca}></img>
      </div>,
      <div className="inline-flex align-items: center; justify-center absolute top-[1000px] gap-20">
        <div>
        <img className='w-[150em] h-[30em] ml-8' src={viagensHome} alt="Imagem de viagens"></img>
        </div>
        <p className="justify-center align-items: center;">
